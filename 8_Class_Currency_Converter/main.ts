...
let Api_data = await fetch("https://v6.exchangerate-api.com/v6/4d2390f40978b1ef431fc4d9/latest/USD").then((R)=> R.json());

// console.log(Api_data); // Api All Data Printed with extra Code...


// API se sirf ham Currency's ka data nikal kar store kar rhy hain baqi ka data skip kar rhy hain... 
let Only_Currency_data = Api_data.conversion_rates;

// console.log(Only_Currency_data); sirf Currency ka data print hoga...


// API object ki sirf key propertys ko alag kar ke aik new veriable mein save kar rhy hain...
...
// .then((R)=> R.json());
// is line ka matlab hai ke fetch se jo Respnce aega agr wo resolve hoga to usy .then ke method se 
// Json string mein convert kar diyya jaega. jab bhi fetch se data mangwaty hain usy json string mein convert karna lazim 
// hota hai kiyun ke wo data hota to json string hi hai lekin Usy Use karne ke liye json string mein convert karna parta hai

// let User_Amount = Only_Currency_data[Currency.have];
// is line ka matlab hai ke User ne jo Currency select ki hai usy (Onlye_currency_data) mein check karo or dhondo 
// agr wo mil jaye to aik new veriable mein save krwa do...